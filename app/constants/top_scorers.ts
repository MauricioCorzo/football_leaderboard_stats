...
export const top_scorers_premier_league: Players[] = [
    {
        player: {
            id: 1100,
            name: 'E. Haaland',
...
export const top_scorers_serie_a: Players[] = [
    {
        player: {
            id: 217,
    ...
    },
    {
        player: {
            id: 26315,
            name: 'N. González',
            firstname: 'Nicolás Iván',
            lastname: 'González',
            age: 27,
            birth: {
                date: '1998-04-06',
                place: 'Belén de Escobar',
                country: 'Argentina',
            },
            nationality: 'Argentina',
            height: '180 cm',
...
export const top_scorers_la_liga: Players[] = [
    {
        player: {
            id: 15811,
            name: 'A. Dovbyk',
...
export const top_scorers_ligue_1: Players[] = [
    {
        player: {
            id: 278,
            name: 'Kylian Mbappé',
...
export const top_scorers_liga_profesional_argentina: Players[] = [
    {
        player: {
            id: 6483,
            name: 'G. Ávalos',
    ...
    },
    {
        player: {
            ...
            weight: '80 kg',
            injured: false,
            photo: 'https://media.api-sports.io/football/players/6038.png',
        },
        statistics: [
            {
                team: {
    ...
    },
    {
        player: {
            ...
            weight: '75 kg',
            injured: false,
            photo: 'https://media.api-sports.io/football/players/6010.png',
        },
        statistics: [
            {
                team: {
    ...
    },
    {
        player: {
            ...
            weight: '84 kg',
            injured: false,
            photo: 'https://media.api-sports.io/football/players/35551.png',
        },
        statistics: [
            {
                team: {
    ...
    },
    {
        player: {
            ...
            weight: '77 kg',
            injured: false,
            photo: 'https://media.api-sports.io/football/players/311344.png',
        },
        statistics: [
            {
                team: {
    ...
    },
    {
        player: {
            ...
            weight: '76 kg',
            injured: false,
            photo: 'https://media.api-sports.io/football/players/35579.png',
        },
        statistics: [
            {
                team: {
    ...
    },
    {
        player: {
            ...
            weight: '74 kg',
            injured: false,
            photo: 'https://media.api-sports.io/football/players/35667.png',
        },
        statistics: [
            {
                team: {
    ...
    },
    {
        player: {
            ...
            weight: '70 kg',
            injured: false,
            photo: 'https://media.api-sports.io/football/players/58478.png',
        },
        statistics: [
            {
                team: {
    ...
    },
    {
        player: {
            ...
            weight: '82 kg',
            injured: false,
            photo: 'https://media.api-sports.io/football/players/11621.png',
        },
        statistics: [
            {
                team: {
    ...
    },
    {
        player: {
            ...
            weight: '72 kg',
            injured: false,
            photo: 'https://media.api-sports.io/football/players/10254.png',
        },
        statistics: [
            {
                team: {
...
export const top_scorers: Partial<Record<LeagueIds, Players[]>> = {
    39: top_scorers_premier_league,
    135: top_scorers_serie_a,
    140: top_scorers_la_liga,
    61: top_scorers_ligue_1,
    128: top_scorers_liga_profesional_argentina,
};
