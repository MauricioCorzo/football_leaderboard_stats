import type { Leaderboard, Place } from '~/interfaces/leaderboard';
import type { LeagueIds } from '..';
import type { League } from '~/interfaces/players';

const premier_league: Leaderboard = {
    league: {
        id: 39,
        name: 'Premier League',
        country: 'England',
...
export const serie_a: Leaderboard = {
    league: {
        id: 135,
        name: 'Serie A',
        country: 'Italy',
        ...
        standings: [
            {
                ...
                update: '2024-05-29T00:00:00+00:00',
            },
            {
                rank: 2,
                team: {
...
const liga_profesional_argentina: Leaderboard = {
    league: {
        id: 128,
        ...
        standings: [
            {
                ...
                update: '2023-08-21T00:00:00+00:00',
            },
            {
                rank: 2,
                team: {
...
export const leaderboard: Record<LeagueIds, Leaderboard> = {
    39: premier_league,
    135: serie_a,
    140: la_liga,
    61: ligue_1,
